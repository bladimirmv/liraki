...
export class RegisterComponent implements OnInit, OnDestroy {
  ...
  private initForm(): void {
    this.registerForm = this.fb.group({
      ...
      celular: [0],
      direccion: [''],
      correo: ['bladimir@gmail.com', [Validators.required, Validators.pattern(/\S+@\S+\.\S+/)]],
      rol: ['cliente', [Validators.required]],
      username: ['blado959', [Validators.required, Validators.minLength(8), Validators.maxLength(10)]],
      contrasenha: ['bmv45645', [Validators.required, Validators.minLength(8), Validators.maxLength(20)]],
      autoUsuario: [false],
